...
extern "C" double EXPORT pricingFRB(
    ...
    , const double girrRiskWeight           // INPUT 25. girr 리스크요소 버킷의 위험 가중치(Curvature 산출 시 사용) 
    , const double csrRiskWeight            // INPUT 26. csr 리스크요소 버킷의 위험 가중치(Curvature 산출 시 사용)
